defmodule Fw.Sim.Lcd do
  ...
  defcast draw_bar(value), state: state do
    new_state lcd_print state, Fw.Lcd.format_bar(value)
  end

  defcast draw_checkbox(value), state: state do
    new_state lcd_print state, Fw.Lcd.format_checkbox(value)
  end

  defcast draw_select(options, value), state: state do
    new_state lcd_print state, Fw.Lcd.format_select(options, value)
  end

  defcast draw_time(hour, minute), state: state do
    new_state lcd_print state, Fw.Lcd.format_time(hour, minute)
  end
