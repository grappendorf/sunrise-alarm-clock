defmodule Fw.Logic do
  use ExActor.GenServer, export: :logic
  alias Fw.{Store, Settings}
  alias Fw.{LogicUiReducers, LogicAlarmReducers, LogicSettingsReducers}
  alias Fw.{LogicUiSubscribers, LogicAlarmSubscribers, LogicSettingsSubscribers}
